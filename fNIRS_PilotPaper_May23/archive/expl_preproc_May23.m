...
for iSub = 4:length(filelist)%1:length(filelist)
...
% Need to export fNIRS results here
...
% writetable(TrialsT,[exportFolder filesep 'Preproc' filesep 'Summary_IncludedTrialsN_' date '.xls']);
% 
