% expl_NIRS_findPeak.m - script to export preprocessed fNIRS data from
...
save([fileName '.mat'],'peaksTable','filelist',...
    'avgPeakLat', 'avgPeakLat_Con1', 'avgPeakLat_Con2', 'avgPeakLat_idx', 'avgPeakLat_Con1_idx', 'avgPeakLat_Con2_idx', 'SDPeakLat_Con1', 'SDPeakLat_Con2');
